...
public class SixWheelTest extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        left_drive_a = hardwareMap.get(DcMotor.class, "LT");
        left_drive_b = hardwareMap.get(DcMotor.class, "LB");
        right_drive_a = hardwareMap.get(DcMotor.class, "RT");
        right_drive_b = hardwareMap.get(DcMotor.class, "RB");
        ...
        left_drive_a.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        left_drive_b.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        right_drive_a.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        right_drive_b.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
